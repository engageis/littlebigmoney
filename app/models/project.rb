  ...
  def as_json(options={})
    {
      ...
      url: Rails.application.routes.url_helpers.project_by_slug_path(kind, permalink, :locale => I18n.locale),
      full_uri: Rails.application.routes.url_helpers.project_by_slug_url(kind, permalink, :locale => I18n.locale),
      expired: expired?,
